    ...
    pub async fn send_raw(&mut self, params: CreateMessageParams) -> Result<Response, ClewdrError> {
        ...
        let endpoint = self
            ...
            .map_err(|_| ClewdrError::BadRequest {
                msg: "Failed to construct conversation endpoint URL",
            })?;
        ...
        let endpoint = self
            ...
            .map_err(|_| ClewdrError::BadRequest {
                msg: "Failed to construct completion endpoint URL",
            })?;
    ...
    pub async fn fetch_org_uuid(&self) -> Result<String, ClewdrError> {
        let endpoint =
            self.endpoint
                ...
                .map_err(|_| ClewdrError::BadRequest {
                    msg: "Failed to construct organizations endpoint URL",
                })?;
        ...
        let uuid = json
            ...
            .ok_or(ClewdrError::UnexpectedNone {
                msg: "No organization UUID found",
            })?;
